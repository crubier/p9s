...
import { computeIndexRange, computeProduct, enumerateTreeNodesAndEdgesBreadthFirst, generateRandomBitmap, generateRandomPairsInRanges, generateRegularPairsInRanges, type PostgresTestContext } from './testing.mts';
import { setupTests } from './testing.mts';
setupTests();

test<PostgresTestContext>('SQL integer benchmark', async ({ client, database_admin_username, database_user_username, runTestQuery }) => {
