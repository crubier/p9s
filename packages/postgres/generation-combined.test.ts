...
test('Default Migration', () => {
  expect(compile(createMigration({
    ...
    -----------------------------------------------------------------------------------------------------------------------
    drop table if exists \\"assignment_edge_cache\\" cascade;

    create table \\"assignment_edge_cache\\" (
      \\"role_id\\" integer not null,
      \\"resource_id\\" integer not null,
      \\"permission\\" bit(4),
      constraint \\"assignment_edge_cache_pkey\\" primary key (\\"role_id\\", \\"resource_id\\"),
      constraint \\"assignment_edge_cache_role_fkey\\" foreign key (\\"role_id\\") references \\"role_node\\" (\\"id\\"),
      constraint \\"assignment_edge_cache_resource_fkey\\" foreign key (\\"resource_id\\") references \\"resource_node\\" (\\"id\\")
    );
    ...
    grant select, insert, update, delete on table \\"assignment_edge_cache\\" to \\"user1\\";
    ...
    -----------------------------------------------------------------------------------------------------------------------
    -- This direction is easy, since we have less parents than children in general
    create view \\"assignment_edge_cache_view\\" as
    select
      \\"the_edge_cache\\".\\"child_id\\" as \\"role_id\\",
      \\"the_assignment\\".\\"resource_id\\" as \\"resource_id\\",
      \\"or_bitmap_4\\" (\\"the_assignment\\".\\"permission\\" & \\"the_edge_cache\\".\\"permission\\") as \\"permission\\" -- bitwise \\"or\\" on permissions between various paths
    from
    ...
    grant select on table \\"assignment_edge_cache_view\\" to \\"user1\\";
    ...
    create or replace function \\"assignment_edge_cache_backfill\\" ()
      ...
      on conflict on constraint \\"assignment_edge_cache_pkey\\"
        do update set
          \\"permission\\" = excluded.\\"permission\\"
        returning
          *
    ...
    grant execute on function \\"assignment_edge_cache_backfill\\" () to \\"user1\\";
    ...
    grant execute on function \\"assignment_trigger_enable\\" () to \\"user1\\";
    ...
    grant execute on function \\"assignment_trigger_disable\\" () to \\"user1\\";
